...
<body>
 ...
 <header style="text-align: center; padding: 20px 0;">
  ...
  <!-- 🏗️ Sección de mantenimiento -->
  <section class="mantenimiento">
    <img src="/velora-mvc/public/img/mantenimiento.png.webp" alt="Página en mantenimiento">
    <h2>Página en mantenimiento</h2>
    <p>Estamos renovando tu espacio de autocuidado.<br>
    Muy pronto, volverá con más calma, más esencia y más belleza natural.</p>
